...
config.General.requestName   = 'fullrun2_2017_version5_TT'
...
#config.Data.outputDatasetTag = '17'
#config.Data.outputPrimaryDataset = '17'
...
config.Data.outputDatasetTag = 'fullrun2_2017_version5_TT'
