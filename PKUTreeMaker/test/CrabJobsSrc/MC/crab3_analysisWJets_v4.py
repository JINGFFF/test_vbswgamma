...
config.General.requestName   = 'fullrun2_2017_pujetID_version5_loose_WJets_2j_v1'
...
config.Data.outputDatasetTag = 'fullrun2_2017_pujetID_version5_loose_WJets_2j_v1'
