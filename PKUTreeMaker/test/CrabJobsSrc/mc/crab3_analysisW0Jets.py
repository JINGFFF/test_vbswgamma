...
config.General.requestName   = 'jec_source_v2_full_run2_2018_check_fakephoton_W0Jets_v1'
...
config.Data.outputDatasetTag = 'jec_source_v2_full_run2_2018_check_fakephoton_W0Jets_v1'
