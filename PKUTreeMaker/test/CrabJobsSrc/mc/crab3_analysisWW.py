...
config.General.requestName   = 'jec_source_v3_full_run2_2018_PUJetID_WW_version2'
...
config.Data.outputDatasetTag = 'jec_source_v3_full_run2_2018_PUJetID_WW_version2'
