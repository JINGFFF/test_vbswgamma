...
config.General.requestName   = 'jec_source_v2_full_run2_2018_PUJetID_WGJets_PDF_Weight_version3_version6'
...
config.Data.outputDatasetTag = 'jec_source_v2_full_run2_2018_PUJetID_WGJets_PDF_Weight_version3_version6'
