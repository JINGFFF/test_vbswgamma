...
config.General.requestName   = 'jec_source_v2_full_run2_2018_PUJetID_WAJJ_aqgc_version5'
...
config.Data.outputDatasetTag = 'jec_source_v2_full_run2_2018_PUJetID_WAJJ_aqgc_version5'
