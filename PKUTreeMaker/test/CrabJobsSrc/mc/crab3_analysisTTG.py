...
config.General.requestName   = 'jec_source_v2_full_run2_2018_PUJetID_TTG_version1'
...
config.Data.outputDatasetTag = 'jec_source_v2_full_run2_2018_PUJetID_TTG_version1'
